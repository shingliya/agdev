...
/********************************************************************************
Remove object to this grid
********************************************************************************/
void CGrid::RemoveObject(int pos)
{
	ListOfObjects.erase(ListOfObjects.begin() + pos);
}

void CGrid::RemoveObjectByAddress(CSceneNode* theObject)
{
